...
import { Bookmark, Copy, Download, Edit2, ExternalLink, Eye, EyeOff, Heart, Loader2, Minimize2, MinusCircle, PlusCircle, RefreshCw, Search, Sparkles, Star, Trash2 } from "lucide-react"
...
const AnalysisActionButton = ({
 ...
 ModalTags = ({ tags }: { tags: readonly string[] }) =>
  (
    <div>
