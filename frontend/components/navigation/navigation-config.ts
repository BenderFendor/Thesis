...
const LIBRARY_NAVIGATION: readonly RouteNavigationItem[] = [
  ...
  VIEW_NAVIGATION: readonly ViewNavigationItem[] = [
    ...
    {
      description: "Read a continuous news stream",
      icon: ScrollText,
      key: "scroll",
      label: "Scroll",
    },
    {
      description: "Compare missing and uneven coverage",
      icon: ArrowRightLeft,
      key: "blindspot",
      label: "Blindspot",
    },
  ...
  WIKI_NAVIGATION: readonly RouteNavigationItem[] = [
    {
      description: "Investigate a question with sources and live tool activity",
      href: "/search",
      icon: Search,
      label: "Research",
...
export { LIBRARY_NAVIGATION, isViewMode, VIEW_NAVIGATION, type ViewMode, WIKI_NAVIGATION };
