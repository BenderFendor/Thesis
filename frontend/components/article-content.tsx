...
const ARTICLE_CONTENT_STYLE = { whiteSpace: "pre-wrap", wordBreak: "break-word" } as const,
  ArticleContent = forwardRef<HTMLDivElement, Readonly<ArticleContentProps>>(
    (...args: Readonly<[Readonly<ArticleContentProps>, Readonly<object> | null]>) => {
      const [props, ref] = args,
        { activeHighlightId, className, content, highlights, onHighlightClick } = props;

      return (
        <div
          ref={getArticleContentRef(ref)}
