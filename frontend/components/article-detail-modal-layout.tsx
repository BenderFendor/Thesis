...
import { ModalActions, ModalAiCleanNote, ModalTags } from "./article-detail-modal-actions";
import {
  ModalArticleReader,
  ModalHeaderControls,
  ModalHero,
...
import { ArticleDetailDialogOverlays } from "./article-detail-modal-overlays";

interface ArticleDetailColumnProps {
  readonly columnProps: DeepReadonly<ArticleDetailDialogColumnsProps>;
}
...
const ArticleDetailDialogBody = ({
  ...
  ArticleDetailDialogChrome = ({
    ...
    onNavigateArticle,
    onToggleExpanded,
  }: Readonly<ArticleDetailDialogChromeProps>) => {
    const bodyHandlers = getBodyHandlers(bodyProps);
    return (
    ...
    return (
      ...
      >
        <ModalProgressRail
          ...
          progress={columnProps.articleScrollProgress}
        />
        <ModalHero
        ...
        <div className={getScrollContentClassName(columnProps.isExpanded)}>
          {columnProps.showSummary && (
            <ModalSummaryQuote
              summary={columnProps.currentArticle.summary}
              isExpanded={columnProps.isExpanded}
            />
          )}
