...
interface ArticleDetailDialogBodyProps {
  ...
  readonly agenticHistory: readonly Readonly<{
    claim: string;
    answer: string;
    timestamp: number;
  }>[];
...
type ArticleDetailDialogColumnsProps = Omit<
  ArticleDetailDialogBodyProps,
  "contentScrollRef" | "progressTrackRef"
>;
...
interface DebugLoaderState {
  ...
  readonly services: ArticleDetailServices;
  readonly setDebugData: (data: ReadonlySourceDebugData | undefined) => void;
...
interface ModalHighlightActionsProps {
  ...
  readonly updateHighlightsWithHistory: (
    updater: (previous: ReadonlyLocalHighlights) => LocalHighlight[],
  ) => void;
...
interface ModalHighlightEditorActionsProps {
  ...
  readonly updateHighlightByStableId: (
    stableId: string,
    updater: (highlight: Readonly<LocalHighlight>) => LocalHighlight,
  ) => void;
  readonly updateHighlightsWithHistory: (
    updater: (previous: ReadonlyLocalHighlights) => LocalHighlight[],
  ) => void;
