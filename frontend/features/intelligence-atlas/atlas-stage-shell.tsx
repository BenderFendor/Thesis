    ...
    <>
      ...
      <footer className={styles.dock}>
        ...
        <div className="flex items-center gap-2">
          <button type="button" className={styles.actionButton} aria-label="Browse all Atlas entities" onClick={onOpenIndex}><BookOpen className="h-4 w-4" /> <span>Browse all</span></button>
          <button type="button" className={styles.actionButton} aria-label="Open Atlas operations" onClick={onOpenOperations}><Activity className="h-4 w-4" /> <span>Operations</span></button>
        </div>
      </footer>
    </>
  );
