...
const createEmbeddedMarkdownComponents = (
  ...
  li: ({ children }: MarkdownChildrenProps) => <li className="text-foreground/80">{children}</li>,
  ...
  ul: ({ children }: MarkdownChildrenProps) => <ul className="my-3 space-y-1">{children}</ul>,
});
