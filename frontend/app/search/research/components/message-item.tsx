...
const getMessageClass = (message: Message): string => {
  if (message.type === "user") {
    return "border-border/5 bg-[var(--news-bg-secondary)]/30 sm:ml-20";
  }
  if (message.error === true) {
    return "border-border/5 bg-destructive/5 sm:mr-12";
  }
...
const ConversationMessageItem = (props: MessageItemProps) => {
  ...
  return (
    <motion.div
      ...
      className={`min-w-0 rounded-xl border px-3 py-3.5 [overflow-wrap:anywhere] sm:px-5 ${messageClass}`}
    >
