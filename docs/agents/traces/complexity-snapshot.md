...
Commit: `fa04d9f0fd39ac414fc88234d6349781be901dfc`
...
| `backend/scripts/verify_and_promote_reporters.py:141` | `_extract_author_from_jsonld` | 17 | 48 |
...
| `backend/app/services/resource_monitor.py:108` | `read_jsonl_records` | 19 | 45 |
...
| `frontend/tools/oxlint/anti-slop/rules/no-widen-then-assert.ts:200` | `knownValueEvidence` | 27 | 19 |
...
| `frontend/tools/oxlint/anti-slop/shared/dictionary-types.ts:190` | `unsafeDirectValue` | 25 | 32 |
| `frontend/tools/oxlint/anti-slop/shared/dictionary-types.ts:246` | `dictionaryValueTypes` | 25 | 30 |
...
| `frontend/tools/oxlint/anti-slop/shared/dictionary-types.ts:51` | `createTypeEnvironment` | 23 | 37 |
...
| `frontend/tools/oxlint/thesis/index.mjs:167` | `CallExpression` | 23 | 14 |
...
| `frontend/tools/oxlint/anti-slop/shared/dictionary-types.ts:340` | `classifyWideningTarget` | 22 | 25 |
...
| `frontend/tools/oxlint/anti-slop/rules/no-widen-then-assert.ts:52` | `isBroadRecordType` | 22 | 14 |
...
| `frontend/tools/oxlint/anti-slop/shared/dictionary-types.ts:411` | `classifyAliasBroadTarget` | 20 | 25 |
...
| `backend/scripts/validate_rss_sources.py:90` | `_first_article_domain` | 19 | 29 |
...
| `backend/app/services/funding_researcher.py:1643` | `_merge_wikidata_sparql_data` | 19 | 23 |
...
| `backend/app/services/funding_researcher.py:1607` | `_merge_wikidata_data` | 19 | 21 |
...
| `backend/scripts/verify_and_promote_reporters.py:564` | `_try_wayback_author_page` | 18 | 28 |
...
| `backend/app/services/littlesis_integration.py:377` | `extract_affiliations_from_relationships` | 14 | 27 |
...
| `backend/news_research_agent.py:754` | `search_internal_news` | 18 | 21 |
...
| `backend/news_research_agent.py:1462` | `call_model` | 16 | 26 |
...
| `backend/scripts/verify_and_promote_reporters.py:492` | `_try_rss_feed_verification` | 15 | 26 |
...
| `backend/app/services/littlesis_integration.py:454` | `get_littlesis_affiliations_for_reporter` | 16 | 21 |
...
| `frontend/tools/oxlint/anti-slop/rules/no-unknown-returns.ts:42` | `resolvesToUnknown` | 16 | 15 |
...
| `backend/app/services/rss_ingestion.py:308` | `_merge_partial_cache_update` | 15 | 18 |
...
| `frontend/tools/oxlint/anti-slop/rules/no-widen-then-assert.ts:263` | `widenedBinding` | 15 | 9 |
...
| `backend/app/services/funding_researcher.py:1015` | `_resolve_org_wikidata_sparql` | 11 | 21 |
...
| `backend/app/services/reporter_confidence_scorer.py:200` | `has_verified_author_page_citation` | 14 | 16 |
| `backend/news_research_agent.py:1778` | `research_news` | 14 | 16 |
| `frontend/components/navigation/sidebar-navigation-item.tsx:34` | `SidebarNavigationItem` | 14 | 16 |
| `backend/news_research_agent.py:649` | `_build_fallback_tool_call` | 14 | 15 |
| `frontend/components/reading-queue-sidebar.tsx:1389` | `ReadingQueueSidebar` | 14 | 15 |
| `backend/app/services/reporter_confidence_scorer.py:171` | `is_author_profile_url` | 14 | 14 |
...
| `backend/app/services/funding_researcher.py:1701` | `_merge_sec_data` | 14 | 13 |
...
| `frontend/tools/oxlint/anti-slop/shared/dictionary-types.ts:480` | `isKnownEvidenceExpression` | 14 | 4 |
...
| `backend/scripts/verify_and_promote_reporters.py:232` | `_discover_author_urls_for_reporter` | 13 | 20 |
...
| `frontend/tools/oxlint/thesis/index.mjs:57` | `hasDescendantElement` | 13 | 15 |
...
| `backend/app/services/funding_researcher.py:1216` | `_ai_enhance_org_data` | 13 | 14 |
...
| `backend/news_research_agent.py:1652` | `_build_context_snippet` | 13 | 9 |
...
| `backend/app/services/funding_researcher.py:1146` | `detect_conflicts` | 12 | 18 |
| `backend/app/services/reporter_career_timeline.py:133` | `_shared_owner_findings` | 12 | 18 |
| `backend/app/services/rss_ingestion.py:698` | `_run_post_publish_work` | 12 | 18 |
| `backend/app/services/source_credibility.py:887` | `_calculate_recency` | 12 | 18 |
| `backend/news_research_agent.py:1358` | `_dedup_tool_node` | 12 | 18 |
...
| `backend/app/services/reporter_confidence_scorer.py:99` | `_has_clean_local_byline_identity` | 12 | 16 |
...
| `backend/app/services/littlesis_integration.py:319` | `cross_reference_entities_with_reporters` | 9 | 18 |
| `backend/app/services/reporter_awards.py:104` | `_search_award_data` | 9 | 18 |
| `backend/news_research_agent.py:702` | `_execute_tool_call_with_fallbacks` | 9 | 18 |
| `frontend/tools/oxlint/anti-slop/shared/lexical-type-parameters.ts:35` | `lexicalTypeParameterNames` | 12 | 15 |
...
| `backend/news_research_agent.py:945` | `fetch_article_content` | 12 | 11 |
...
| `frontend/tools/oxlint/anti-slop/rules/no-module-mocking.ts:51` | `moduleMockCall` | 12 | 11 |
...
| `frontend/tools/oxlint/anti-slop/rules/no-object-parameters.ts:52` | `resolvesToObject` | 12 | 9 |
| `frontend/tools/oxlint/anti-slop/rules/no-widen-then-assert.ts:143` | `isDefinitelyNarrowerRecordType` | 12 | 9 |
...
| `backend/app/services/rss_ingestion.py:365` | `_build_article_from_rust_payload` | 11 | 16 |
...
| `backend/scripts/verify_and_promote_reporters.py:71` | `_try_curl_cffi_article_signals` | 11 | 11 |
...
| `backend/news_research_agent.py:1279` | `_dedup_block_message` | 11 | 10 |
...
| `frontend/tools/oxlint/thesis/index.mjs:119` | `isFragileMapKeyExpression` | 11 | 4 |
| `frontend/tools/oxlint/anti-slop/rules/no-widen-then-assert.ts:122` | `isDefinitelyObjectType` | 11 | 3 |
| `frontend/tools/oxlint/thesis/index.mjs:95` | `isMapCallback` | 11 | 2 |
...
| `backend/scripts/verify_and_promote_reporters.py:168` | `_try_curl_cffi_scrape` | 10 | 12 |
| `frontend/lib/api.ts:2162` | `<anonymous>` | 9 | 13 |
| `frontend/tools/oxlint/anti-slop/shared/lexical-type-parameters.ts:14` | `collectInferTypeParameterNames` | 8 | 14 |
...
| `backend/app/services/funding_researcher.py:879` | `_resolve_cik` | 10 | 11 |
| `backend/app/services/funding_researcher.py:1757` | `_apply_ai_enhancements` | 10 | 11 |
...
| `backend/scripts/verify_and_promote_reporters.py:941` | `main_async` | 9 | 12 |
...
| `backend/app/services/funding_researcher.py:514` | `_search_wikipedia` | 9 | 10 |
| `backend/app/services/funding_researcher.py:719` | `_fetch_wikidata` | 9 | 10 |
| `backend/app/services/funding_researcher.py:957` | `_latest_fact_value` | 9 | 10 |
| `backend/app/services/funding_researcher.py:1682` | `_merge_nonprofit_data` | 9 | 10 |
...
| `frontend/tools/oxlint/anti-slop/shared/dictionary-types.ts:383` | `isBroadMappedKey` | 10 | 9 |
...
| `backend/app/services/funding_researcher.py:595` | `_extract_ownership_from_text` | 9 | 9 |
| `backend/app/services/reporter_confidence_scorer.py:126` | `_looks_like_combined_byline_name` | 9 | 9 |
...
| `backend/app/services/funding_researcher.py:491` | `_propublica_name_matches` | 10 | 7 |
| `backend/app/services/funding_researcher.py:1589` | `_merge_wikipedia_data` | 9 | 8 |
...
| `frontend/tools/oxlint/thesis/index.mjs:216` | `JSXElement` | 9 | 8 |
| `scripts/scoop.ts:522` | `runSchemaCommand` | 9 | 8 |
| `backend/news_research_agent.py:408` | `_track_search_result_reference` | 9 | 7 |
...
| `frontend/tools/oxlint/anti-slop/shared/dictionary-types.ts:174` | `aliasSubstitution` | 9 | 7 |
