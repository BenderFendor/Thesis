        ...
        if trace:
            ...
            if is_slow_gap:
                self.log_event(
                    ...
                    details={
                        "gap_seconds": gap,
                        "threshold": THRESHOLDS["stream_event_gap"],
                    },
                )
...
debug_logger: DebugLoggerService = DebugLoggerService()
...
def log_stream_event(stream_id: str, event_name: str, **kwargs: Any) -> None:
    """Log a stream event."""
